...
<table class="table table-bordered border-dark">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td> <a class="text-decoration-none" href="?f=pelanggan&m=delete&id=<?php echo $r['idpelanggan'] ?>">Delete</a></td>
            <td> <a class="text-decoration-none" href="?f=pelanggan&m=update&id=<?php echo $r['idpelanggan'] ?>"><?php echo $status?></a></td>
        </tr>
            <?php endforeach ?>
    </tbody>
</table>
