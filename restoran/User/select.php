...
<div>
    ...
    <a type="button" class="btn btn-danger float-end" href="?f=user&m=insert">Tambah Data</a>
</div>
...
<table class="table table-bordered border-dark">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td> <a class="text-decoration-none" href="?f=user&m=update&id=<?php echo $r['iduser'] ?>"><?php echo $status?></a></td>
        </tr>
            <?php endforeach ?>
    </tbody>
</table>
